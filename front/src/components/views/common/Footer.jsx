  ...
  return (
    <footer className="py-8 text-white bg-blue-600">
      <div className="container grid grid-cols-1 gap-8 px-4 mx-auto md:grid-cols-3">
          ...
          <ul className="space-y-2">
            <li>
              <details>
                ...
                <p className="mt-2">
                  Para crear una cuenta, simplemente rellena el formulario y
                  podrás navegar por la página.
                </p>
              </details>
            </li>
            <li>
              <details>
                ...
                <p className="mt-2">
                  Tendrás que completar el formulario de registro, y una vez
                  registrado, iniciarás sesión con tu email y contraseña.
                </p>
              </details>
            </li>
            <li>
              <details>
                <summary className="cursor-pointer">
                  ¿Qué puedo hacer si tengo problemas técnicos?
                </summary>
                <p className="mt-2">
                  Puedes ponerte en contacto con nuestro equipo de soporte
                  técnico a través de la plataforma, y recibirás asistencia
                  personalizada.
                </p>
              </details>
            </li>
        ...
        <div className="flex flex-col items-center">
          <p className="text-sm">
            © 2024 MiSistema. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
