...
const CreditDetail = () => {
  ...
  const mapeo = () => {
    return shares.map((c) => (
      <tr key={c.id}>
        <td className="px-3 py-5 text-sm border-b border-gray-200">{c.id}</td>
        <td className="px-3 py-5 text-sm border-b border-gray-200">
          {c.expirate_date}
        </td>
        <td className="px-3 py-5 text-sm border-b border-gray-200">
          {c.number_share}
        ...
        <div className="p-6">
          <div className="mb-5">
            ...
            <h3 className="text-xl font-semibold">
              Monto Total: ${credit.amount}
            </h3>
            <h3 className="text-xl font-semibold">
              Interés: {credit.interest}%
            </h3>
          ...
          <table className="min-w-full leading-normal ">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="px-3  py-3 text-sm font-semibold tracking-wider text-left text-gray-700 uppercase border-b-2 border-gray-200">
                  Estado
                </th>
              </tr>
            </thead>
