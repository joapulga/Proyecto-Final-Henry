...
export class Initial1727197730357 implements MigrationInterface {
    name = 'Initial1727197730357'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(20) NOT NULL, "lastname" character varying(20) NOT NULL, "dni" character varying(10) NOT NULL, "phone" character varying(20) NOT NULL, "email" character varying(100) NOT NULL, "password" character varying(200) NOT NULL, "is_admin" boolean NOT NULL DEFAULT false, "img_url" character varying, "stateId" uuid, CONSTRAINT "UQ_5fe9cfa518b76c96518a206b350" UNIQUE ("dni"), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "shares" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "number_share" integer NOT NULL, "expirate_date" date NOT NULL, "paid_date" date NOT NULL, "capital" numeric NOT NULL, "interes" numeric NOT NULL, "amount" numeric(10,2) NOT NULL, "creditId" uuid, "stateId" uuid, CONSTRAINT "PK_b88473409066c43c2ccb1894a82" PRIMARY KEY ("id"))`);
