...
export class Last1727374793666 implements MigrationInterface {
    name = 'Last1727374793666'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "shares" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "number_share" integer NOT NULL, "expirate_date" date NOT NULL, "paid_date" date NOT NULL, "capital" date NOT NULL, "interes" date NOT NULL, "amount" numeric(10,2) NOT NULL, "creditId" uuid, "stateId" uuid, CONSTRAINT "PK_b88473409066c43c2ccb1894a82" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "credits" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount" numeric(10,4) NOT NULL, "months" integer NOT NULL, "interest" numeric(10,2) NOT NULL, "userId" uuid, "stateId" uuid, CONSTRAINT "PK_45cea097fd0ee625d2e840ed99c" PRIMARY KEY ("id"))`);
